          ...
          <Form ref={this.formRef} layout="vertical" name="nest-messages" validateMessages={this.validateMessages}>
            ...
            <Input.Group compact>
                ...
                label="Contract Begin Date" rules={[{ required: true }]}  style={{ width: '50%' }}>
                    <DatePicker disabledDate={value => this.formRef.current?.getFieldValue('contractEndDate') != null && value > this.formRef.current?.getFieldValue('contractEndDate')}onChange={value => this.setState({contractBeginDate: moment(String(value))})}  style={{ width: '100%' }} />
                </Form.Item>
                ...
                label="Contract End Date" style={{ width: '50%' }}>
                    <DatePicker disabledDate={value => value <= this.formRef.current?.getFieldValue('contractBeginDate')} onChange={value => this.setState({contractEndDate: moment(String(value))})}  style={{ width: '100%' }} />
                </Form.Item>
            </Input.Group>
