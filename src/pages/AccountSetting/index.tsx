...
import { Row, Card, Input, Col, Image, Typography, Form, Button, Space, message } from 'antd';
...
export class AccountSetting extends React.Component<IAccountSettingsProps> {
  ...
  handleUpdateProfileInfo = async (values: UpdateProfileInfoInput) => {
    this.waitForProcess(async () => {
      ...
      await this.props.authenticationStore.updateCurrentUserInfo({firstName, lastName});
    }, "Profile info updated", "Cannot save your profile info");
  }
    ...
    return (
      <>
          ...
          <Row gutter={{ xs: 8, sm: 16, md: 24 }}>
            <Col sm={{ span: 12, offset: 0 }}>
              ...
              >
                ...
                <Space size="middle">
                  <FormItem>
                    <Button type="primary" htmlType="submit" disabled={this.state.processing}>Save</Button>
                  </FormItem>
                  <FormItem>
                    <Button type="default" disabled={!this.state.isDirty} onClick={this.resetProfileInfo}>Reset</Button>
                  </FormItem>
                </Space>
              </Form>
            </Col>
        ...
        <Card title="Password">
          <Row gutter={{ xs: 8, sm: 16, md:24}}>
            <Col sm={{ span: 12, offset: 0 }}>
              <Form ref={this.formPassRef} layout="vertical">
                <FormItem label="Current Password" name="current_password">
                  <Input type="password"></Input>
                </FormItem>
                <FormItem label="New Password" name="new_password">
                  <Input type="password"></Input>
                </FormItem>
                <FormItem label="Confirm New Password" name="confirm_password">
                  <Input type="password"></Input>
                </FormItem>
